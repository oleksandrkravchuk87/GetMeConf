...
func TestFind(t *testing.T) {
	...
	mongodbConfig := entitys.Mongodb{Domain: "testDomain", Mongodb: true, Host: "testHost", Port: "testPort"}
	...
	tsConfig := entitys.Tsconfig{Module: "testModule", Target: "testTarget", SourceMap: true, Excluding: 1}
	...
	tempConfig := entitys.Tempconfig{RestApiRoot: "testApiRoot", Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
...
func TestFindAll(t *testing.T) {
	...
	mongodbConfig := entitys.Mongodb{Domain: "testDomain", Mongodb: true, Host: "testHost", Port: "testPort"}
	mongoRows := getMongoDBRows(mongodbConfig.Domain)
	expConfigs := []entitys.Mongodb{mongodbConfig}
	...
	tsConfig := entitys.Tsconfig{Module: "testModule", Target: "testTarget", SourceMap: true, Excluding: 1}
	tsRows := getTsConfigRows(tsConfig.Module)
	expTsConfigs := []entitys.Tsconfig{tsConfig}
	...
	tempConfig := entitys.Tempconfig{RestApiRoot: "testApiRoot", Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
	tempRows := getTempConfigRows(tempConfig.RestApiRoot)
	expTempConfigs := []entitys.Tempconfig{tempConfig}
...
func TestSave(t *testing.T) {
	...
	mongodbConfigErr := entitys.Mongodb{Domain: "testDomainError", Mongodb: true, Host: "testHost", Port: "testPort"}
	expectedError := errors.New("db error")
	m.ExpectExec(formatRequest("INSERT INTO \"mongodbs\" (\"domain\",\"mongodb\",\"host\",\"port\") VALUES ($1,$2,$3,$4) RETURNING \"mongodbs\".*")).
	...
	tsConfigErr := entitys.Tsconfig{Module: "testModuleError", Target: "testTarget", SourceMap: true, Excluding: 1}
	expectedError = errors.New("db error")
	m.ExpectExec(formatRequest("INSERT INTO \"tsconfigs\" (\"module\",\"target\",\"source_map\",\"excluding\") VALUES ($1,$2,$3,$4) RETURNING \"tsconfigs\".*")).
	...
	tempConfigErr := entitys.Tempconfig{RestApiRoot: "testApiRootError", Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
	expectedError = errors.New("db error")
	m.ExpectExec(formatRequest("INSERT INTO \"tempconfigs\" (\"rest_api_root\",\"host\",\"port\",\"remoting\",\"legasy_explorer\") VALUES ($1,$2,$3,$4,$5) RETURNING \"tempconfigs\".*")).
...
func TestUpdate(t *testing.T) {
	m, db, _ := newDB()
	mockRepo := MongoDBConfigRepoImpl{DB: db}
	config := entitys.Mongodb{Domain: "testDomain", Mongodb: true, Host: "testHost", Port: "8080"}
	...
	configErrOne := entitys.Mongodb{Domain: "errOneConfig", Mongodb: true, Host: "testHost", Port: "8080"}
	...
	configErrTwo := entitys.Mongodb{Domain: "errTwoConfig", Mongodb: true, Host: "testHost", Port: "8080"}
	...
	configErrThree := entitys.Mongodb{Domain: "errThreeConfig", Mongodb: true, Host: "", Port: ""}
	...
	tsConfigErrOne := entitys.Tsconfig{Module: "errOneConfig", Target: "testTarget", SourceMap: true, Excluding: 1}
	...
	tsConfigErrTwo := entitys.Tsconfig{Module: "errTwoConfig", Target: "testTarget", SourceMap: true, Excluding: 1}
	...
	tsConfigErrThree := entitys.Tsconfig{Module: "errThreeConfig", Target: "", SourceMap: true, Excluding: 1}
	...
	tempConfigErrOne := entitys.Tempconfig{RestApiRoot: "errOneConfig", Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
	...
	tempConfigErrTwo := entitys.Tempconfig{RestApiRoot: "errTwoConfig", Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
	...
	tempConfigErrThree := entitys.Tempconfig{RestApiRoot: "errThreeConfig", Host: "", Port: "", Remoting: "", LegasyExplorer: true}
...
func getMongoDBRows(configID string) *sqlmock.Rows {
	...
	mongodbConfig := entitys.Mongodb{Domain: configID, Mongodb: true, Host: "testHost", Port: "testPort"}
...
func getTsConfigRows(configID string) *sqlmock.Rows {
	...
	rows := sqlmock.NewRows(fieldNames)
	tsConfig := entitys.Tsconfig{Module: configID, Target: "testTarget", SourceMap: true, Excluding: 1}
...
func getTempConfigRows(configID string) *sqlmock.Rows {
	...
	rows := sqlmock.NewRows(fieldNames)
	tempConfig := entitys.Tempconfig{RestApiRoot: configID, Host: "testHost", Port: "testPort", Remoting: "testRemoting", LegasyExplorer: true}
